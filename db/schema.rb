...
ActiveRecord::Schema.define(version: 20171220200249) do
  ...
  create_table "daily_forecasts", force: :cascade do |t|
    ...
    t.index ["search_id"], name: "index_daily_forecasts_on_search_id"
  end
  ...
  create_table "hourly_forecasts", force: :cascade do |t|
    ...
    t.datetime "time"
    t.string "formatted_time"
    t.index ["search_id"], name: "index_hourly_forecasts_on_search_id"
  end
  ...
  add_foreign_key "daily_forecasts", "searches"
  add_foreign_key "hourly_forecasts", "searches"
